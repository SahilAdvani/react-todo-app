    ...
    <>
      ...
      <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[45%]">
          ...
          <div className="addTodo my-5 flex flex-col gap-4">
            ...
            <button onClick={handleAdd} disabled={todo.length<=3} className='bg-violet-800 hover:bg-violet-950 disabled:bg-violet-500 p-4 py-2 text-sm font-bold text-white rounded-full cursor-pointer mx-2'>Save</button>
            </div>
          </div>
